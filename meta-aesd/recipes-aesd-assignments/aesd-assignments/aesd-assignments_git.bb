...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-wangmengj.git;protocol=ssh;branch=main"

PV = "1.0+git${SRCPV}"
# TODO: set to reference a specific commit hash in your assignment repo
#SRCREV = "f99b82a5d4cb2a22810104f89d4126f52f4dfaba"
SRCREV = "907f44dd82ff3d75f9c6f608d79df4e161f416b6"
...
FILES:${PN} += "${sysconfdir}/rc4.d/S99aesdsocket"
FILES:${PN} += "${sysconfdir}/rc5.d/S99aesdsocket"
...
do_install () {
    ...
    ln -sf ../init.d/aesdsocket-start-stop ${D}${sysconfdir}/rc4.d/S99aesdsocket
